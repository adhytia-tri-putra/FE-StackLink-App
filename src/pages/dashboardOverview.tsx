...
const IconMail = ({ className = "h-5 w-5", ...props }: IconProps) => (
  <svg
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M4 7l8 5 8-5M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"
    />
  </svg>
);
          ...
          <div className="min-w-0">
            ...
            <div className="grid gap-4 2xl:grid-cols-[1fr_288px]">
                  ...
                  <div>
                    ...
                    <div className="mt-8">
                      ...
                      <div className="mt-2 flex flex-wrap items-end gap-3">
                        ...
                        <p className="pb-1.5 text-sm font-semibold text-primary">
                          up 14%
                        </p>
                      </div>
                    </div>
              ...
              <button
                ...
                <span className="text-[22px] font-medium leading-tight">
                  Create New Link
                </span>
                    ...
                    return (
                      <div
                        ...
                        <div className="flex min-w-0 items-center gap-4">
                          <span
                            className={`flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-full ${theme.bg} ${theme.text}`}>
