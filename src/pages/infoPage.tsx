...
const content: Record<string, { title: string; body: string[] }> = {
  "/privacy": { title: "Privacy Policy", body: ["StackLink stores account information, profile content, links, and click analytics needed to operate the service.", "Visitor IP addresses are stored only as salted one-way hashes. Click records are deleted after the configured retention period, which defaults to 90 days.", "Google Analytics, Meta Pixel, and TikTok Pixel are optional and load only after a visitor accepts tracking on a public profile.", "Passwords are stored as hashes. Reset and verification tokens are single-use hashes with expiration times.", "You may decline optional tracking, clear the StackLink consent choice in browser storage, or delete your account and associated data from Account Settings."] },
