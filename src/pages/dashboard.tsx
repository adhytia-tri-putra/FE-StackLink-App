...
const THEMES = [
  { id: "default", name: "Ocean Glow", bg: "bg-gradient-to-tr from-[#e8f3ff] to-[#d9fbf6]" },
      ...
      <main className="flex-1 flex flex-col overflow-hidden bg-slate-50/50">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8">
          <div className="text-sm font-medium text-slate-500">
            Preview: <span className="text-slate-800 font-bold underline cursor-pointer">stacklink.me/{username}</span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button onClick={handleSave} className="text-sm font-bold text-white bg-[#2388ff] px-6 py-2 rounded-full hover:bg-[#176fd5] shadow-sm">Publish</button>
          </div>
        </header>
          ...
          <div className="max-w-2xl mx-auto space-y-8">
                ...
                <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input value={username} readOnly className="mt-1 w-full p-3 bg-slate-50 rounded-xl border border-slate-200 focus:border-[#2388ff] outline-none" />
                    ...
                    <div>
                      ...
                      <input value={headline} onChange={e => setHeadline(e.target.value)} className="mt-1 w-full p-3 bg-slate-50 rounded-xl border border-slate-200 focus:border-[#2388ff] outline-none" />
                    </div>
                    <div>
                      <label className="text-xs font-bold uppercase text-slate-400">Bio Description</label>
                      <textarea rows={3} value={bio} onChange={e => setBio(e.target.value)} className="mt-1 w-full p-3 bg-slate-50 rounded-xl border border-slate-200 focus:border-[#2388ff] outline-none" />
                    </div>
                  </div>
                </div>
            ...
            {showQR && (
              <div className="flex flex-col items-center gap-4 p-8 bg-white rounded-3xl border-2 border-[#2388ff] animate-bounce-short">
                <QRCodeSVG value={`https://stacklink.me/${username}`} size={180} />
